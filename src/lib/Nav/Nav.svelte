...
<nav class="w-full h-16 sticky z-10 border-b-[1px] shadow-shadow-light dark:shadow-shadow-dark bg-white border-slate-300 dark:border-zinc-700 shadow-lg dark:bg-zinc-800 dark:shadow-xl top-0">
