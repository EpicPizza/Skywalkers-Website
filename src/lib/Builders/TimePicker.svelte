...
<div class="flex items-center gap-2 flex-row">
  <div class="flex items-center gap-2">
    <input
      ...
      class="min-w-[38px] w-full h-[32px] lg:h-[36px] p-2 py-1.5 rounded-md text-center lg:text-lg"
      type="string"
    />
    ...
    <input
      ...
      class="min-w-[38px] w-full h-[32px] lg:h-[36px] lg:text-lg p-2 py-1.5 rounded-md text-center"
      type="string"
    />
    <button
      ...
      class="b-accent flex items-center justify-around w-[43px] lg:h-[36px] h-[32px] lg:text-lg"
      >{start.getHours() >= 12 && start.getHours() != 24 ? "pm" : "am"}</button
    >
  </div>
  ...
  <div class="flex items-center gap-2">
    ...
    <input
      ...
      value={end.getMinutes() < 10 ? "0" + end.getMinutes() : end.getMinutes()}
    ...
    <button
      ...
      class="b-accent flex items-center justify-around w-[43px] h-[32px] lg:h-[36px] lg:text-lg"
