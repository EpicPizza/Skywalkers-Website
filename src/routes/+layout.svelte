<script lang="ts">
  ...
  $: iconInfo =
    $teamInfo.get($page.data.unverifiedTeam ?? $team ?? "000000")?.icon ??
    "/favicon.webp";
  ...
  onMount(() => {
    ...
    console.warn(
      "%cDo not enter or share anything here or your account could be compromised.",
      "font-size: 1.5rem;",
    );
  });
</script>
...
<svelte:head>
  ...
  <link
    rel="stylesheet"
    href="https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@40,700,0,0"
  />
