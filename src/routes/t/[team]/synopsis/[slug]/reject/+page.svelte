  ...
  <div class="w-[36rem] lg:w-[44rem]">
    ...
    <div class="opacity-75 flex items-center mb-4 lg:mb-6">
      ...
      <p class="ml-2 lg:text-lg">
        By rejecting the synopsis of {data.meeting.name}, you will be deleting
        it's synopsis and it's attachments forever. The linked meeting will also
        be marked as active again. (Synopsis might still remain in discord,
        however images and files will be deleted.)
      </p>
    </div>
    <form method="POST">
