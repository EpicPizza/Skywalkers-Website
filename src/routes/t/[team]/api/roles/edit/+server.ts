...
export const POST = (async ({ locals, request }) => {
    ...
    await db.runTransaction(async (transaction) => {
        ...
        if(role.name != 'everyone') {
            ...
            userRefs = (await transaction.get(db.collection('users').where("team", "array-contains", team))).docs;
        }
        ...
        firebaseAdmin.addLogWithTransaction("Edited a role.", "group", user, transaction, team);
    })
