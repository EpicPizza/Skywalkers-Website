...
<Background>
  <Page>
    ...
    <a
      href="/t/{$team}/settings/roles"
      class="flex p-8 py-4 mb-3 gap-4 items-center rounded-lg bg-black dark:bg-white bg-opacity-5 dark:bg-opacity-5 hover:bg-opacity-10 dark:hover:bg-opacity-10 transition cursor-pointer"
    >
      <Icon icon="group" scale="2.5rem"></Icon>
      <div class="ml-4">
        <h2 class="mb-1 text-xl">Roles and Permissions</h2>
        <h3 class="opacity-75">
          Create, delete, and edit roles here. List, add, and remove members
          from specific roles here too.
        </h3>
      </div>
    </a>
    {#if $permissions.includes("MANAGE_CODES")}
      <a
        href="/t/{$team}/settings/invites"
        class="flex p-8 py-4 gap-4 mb-3 items-center rounded-lg bg-black dark:bg-white bg-opacity-5 dark:bg-opacity-5 hover:bg-opacity-10 dark:hover:bg-opacity-10 transition cursor-pointer"
      >
        <Icon icon="vpn_key" scale="2.5rem"></Icon>
        <div class="ml-4">
          <h2 class="mb-1 text-xl">Invites</h2>
          <h3 class="opacity-75">
            Invite people to the team with their email and edit their
            invitations.
          </h3>
        </div>
      </a>
    ...
    {#if $permissions.includes("VIEW_LOGS")}
      ...
      >
        ...
        <div class="ml-4">
          ...
          <h3 class="opacity-75">
            View logs about who and when regarding meetings, role, codes, etc.
          </h3>
        </div>
      </a>
    {/if}
    ...
    >
      ...
      <div class="ml-4">
        ...
        <h3 class="opacity-75">
          View all team members. Edit roles and profiles of members. Kick and
          unkick members.
        </h3>
      </div>
    </a>
    {#if $client && $client.teams != undefined}
      ...
      >
        <button
          on:click={handleKickMember}
          class="flex p-8 py-4 gap-4 items-center rounded-lg bg-red-500 dark:bg-red-500 bg-opacity-10 dark:bg-opacity-10 hover:bg-opacity-20 dark:hover:bg-opacity-20 transition cursor-pointer"
        >
          <Icon icon="logout" scale="2.5rem"></Icon>
          <div class="ml-4">
            <h2 class="mb-1 text-xl text-left">Leave Team</h2>
            <h3 class="opacity-75 text-left">
              All your data in this team will be deleted such as hours, roles,
              and permissions.
            </h3>
          </div>
        </button>
