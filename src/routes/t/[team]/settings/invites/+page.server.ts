...
import { SENDGRID, SENDGRIDFROM, SENDGRIDNAME, SENDGRIDTEMPLATE, SENDGRIDREPLYTO, DOMAIN, SENDGRIDINVITE } from "$env/static/private";
...
export const actions = {
    generate: async ({ request, locals }) => {
        ...
        const sending = await db.runTransaction(async t => {
            ...
            firebaseAdmin.addLogWithTransaction("Generated code(s).", "vpn_key", uid, t, team);
        ...
        if(sending != undefined) {
            const msg = {
                ...
                subject: "Invitation to " + locals.teamInfo.get(team)?.name + " Team Website",
                dynamicTemplateData: {
