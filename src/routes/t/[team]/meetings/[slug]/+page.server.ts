...
export async function load({ params, locals, url }) {
    ...
    if(isPublic && meeting.completed) throw error(400, "Cannot view completed meetings without account.");
    ...
    return { 
        ...
        public: checkingPublic && safeCompare(checkingPublic, url.searchParams.get('public') ?? "000000") ? url.searchParams.get('public') ?? "000000" : null,
    };
}