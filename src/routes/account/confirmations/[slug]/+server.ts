...
const Preference = z.union([z.literal('email'), z.literal('discord'), z.literal('phone'), z.literal('none')]);
...
export async function POST({ request, locals, params }) {
    ...
    const ref = db.collection('users').doc(locals.user.uid).collection('settings').doc('confirmations');
