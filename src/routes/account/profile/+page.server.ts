...
export async function load({locals}) {
    ...
    if(locals.firestoreUser == undefined || locals.team == undefined) throw error(403, "Must be verified");
...
export const actions = {
    default: async ({ request, locals }) => {
        ...
        await db.runTransaction(async t => {
            ...
            firebaseAdmin.addLogWithTransaction("Edited profile.", "badge", uid, t, team);
        })
