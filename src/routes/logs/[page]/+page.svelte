    ...
    <div class="w-[36rem] min-h-full relative">
        <div class="flex justify-between">
            ...
            <div class="flex gap-2 items-center">
                <svelte:element this={data.page.beginning ? "button" : "a"} disabled={data.page.beginning}  href="/logs/1"  class="b-primary disabled:opacity-50 rotate-180"><Icon icon=double_arrow></Icon></svelte:element>
                <svelte:element this={data.page.beginning ? "button" : "a"} disabled={data.page.beginning}  href="/logs/{data.page.on - 1}"  class="b-primary disabled:opacity-50"><Icon icon=arrow_back></Icon></svelte:element>
                <p class="mx-2">{data.page.showing} / {data.page.total.count}</p>
                <svelte:element this={data.page.end ? "button" : "a"} disabled={data.page.end} href="/logs/{data.page.on + 1}" class="b-primary disabled:opacity-50"><Icon icon=arrow_forward></Icon></svelte:element>
                <svelte:element this={data.page.end ? "button" : "a"} disabled={data.page.end}  href="/logs/{data.page.total.pages}"  class="b-primary disabled:opacity-50"><Icon icon=double_arrow></Icon></svelte:element>
            </div>
        </div>
