<script lang=ts> 
    ...
    import { loading, localLoading, warning } from "$lib/stores.js";
...
<form method="POST" use:enhance>
    <div class="flex-row flex gap-4 mt-4">
        <div>
            ...
            <input autocomplete="off" bind:value={$form.member_id} placeholder=000000 name="member_id" class="p-2 mt-2 w-full border-zinc-200 dark:border-zinc-700 dark:bg-zinc-800 border-[1px] rounded-md pl-3" type="string">
        </div>
        <div>
            ...
            <input autocomplete="off" bind:value={$form.team_id} placeholder=000000 name="team_id" class="p-2 mt-2 w-full border-zinc-200 dark:border-zinc-700 dark:bg-zinc-800 border-[1px] rounded-md pl-3" type="string">
        </div>
    </div>
